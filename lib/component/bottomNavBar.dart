  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: _onTabTapped,
        backgroundColor: Colors.white, // 设置底部导航栏背景颜色
        selectedItemColor: Colors.cyan, // 选中项颜色
        unselectedItemColor: Colors.black, // 未选中项颜色
        selectedLabelStyle: TextStyle(color: Colors.cyan), // 选中状态下标签文字颜色
...
//     setState(() {
//       _currentIndex = index;
//       _showBottomNav = index < 4; // 隐藏底部导航栏，页面索引 >= 4
//     });
//   }
//
//   @override
...
//                 backgroundColor: Colors.white, // 设置底部导航栏背景颜色
//                 currentIndex: _currentIndex,
//                 onTap: _updateBottomNavVisibility,
//                 selectedItemColor: Colors.cyan, // 选中项颜色
//                 unselectedItemColor: Colors.black, // 未选中项颜色
//                 selectedLabelStyle: TextStyle(color: Colors.cyan), // 选中状态下标签文字颜色
//                 unselectedLabelStyle: TextStyle(color: Colors.black), // 未选中状态下标签文字颜色
//                 items: [
//                   BottomNavigationBarItem(
//                     label: '主页',
//                     icon: Column(
